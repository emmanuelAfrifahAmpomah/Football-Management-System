							...
							<div class="card-body pt-0">
								<div class="row">
									<div class="col-xl-6 col-lg-6 col-md-12">
										<div class="blog-img">
											...
											<div class="blog-text">
												...
												<img src="images/contacts/pic1.jpg" class="avatar rounded-circle me-2" alt="">
									...
									<div class="col-xl-6 col-lg-6 col-md-12">
										<div class="blog-post">
											<div class="post-1">
												<img src="images/profile/friends/f1.jpg" class="avatar rounded-circle me-2 custome-avatar" alt="">
												<div class="post-data">
											...
											<div class="post-1">
												<img src="images/profile/friends/f2.jpg" class="avatar rounded-circle me-2 custome-avatar" alt="">
												<div class="post-data">
											...
											<div class="post-1">
												<img src="images/profile/friends/f3.jpg" class="avatar rounded-circle me-2 custome-avatar" alt="">
												<div class="post-data">
											...
											<div class="post-1">
												<img src="images/profile/friends/f4.jpg" class="avatar rounded-circle me-2 custome-avatar" alt="">
												<div class="post-data">
								...
								<div class="card">
									...
									<div class="card-body pt-0">
										<div class="blog-img">
											...
											<div class="blog-text">
												<h2>This quote highlights the importance of writing clear.</h2>
												<img src="images/contacts/pic1.jpg" class="avatar rounded-circle me-2 small-post" alt="">
												<span>Hary in February 05, 2023</span>
											</div>
										</div>
										<div class="row">
												...
												<div class="seconday-post">
													...
													<div class="post-1">
														<div class="post-data">
															...
															<h4>Debugging is like being a detective in a crime movie where you're also the murderer.</h4>
															<div>
																<img src="images/contacts/pic2.jpg" class="avatar rounded-circle me-2 small-post" alt="">
																<span><b class="text-primary">Honey</b> in April 05, 2023</span>
															</div>
														</div>
													</div>
										...
										<div class="third-post">
											...
											<div class="post-1">
												<div class="post-data">
													...
													<h4>Debugging is like being a detective movie where you're also the murderer.</h4>
													<div class="mb-2">
														<img src="images/contacts/pic3.jpg" class="avatar rounded-circle me-2 small-post" alt="">
														<span><b class="text-primary">Lisa</b> in April 05, 2023</span>
													</div>
													<span>
														Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
